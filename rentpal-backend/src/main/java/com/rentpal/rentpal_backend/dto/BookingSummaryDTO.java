...
public class BookingSummaryDTO {
    ...
    public BookingSummaryDTO(Long bookingId, String status, LocalDateTime requestDate, 
                           LocalDateTime responseDate, String message, Long tenantId, 
                           String tenantName, Long propertyId, String propertyTitle,
                           double propertyRentAmount, String propertyLocation) {
    ...
    public double getPropertyRentAmount() { return propertyRentAmount; }
    public void setPropertyRentAmount(double propertyRentAmount) { this.propertyRentAmount = propertyRentAmount; }
